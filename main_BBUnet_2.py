...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataset', type=str, default='/home/2017011/reljur01/Synthetic_data/FOLD_M3')
    parser.add_argument("--csv", type=str, default= 'metrics.csv')
    parser.add_argument("--workdir", type=str, default = '/home/2017011/reljur01/Synthetic_data/FOLD_M3/results/DRU_Enc2_3')
    parser.add_argument('--batch_size', type=int, default=2)
    parser.add_argument("--cpu", action='store_true', default = False)
    parser.add_argument("--debug", action="store_true", default = False)
    parser.add_argument("--modalities", type=int, default=3)
    parser.add_argument("--weights", type=str, default='/home/2017011/reljur01/Synthetic_data/FOLD_M3/results/DRU_Enc2_2/best.pkl', help="Stored weights to restore")
    ...
    parser.add_argument("--network", type=str,  help="The network to use", default='DeformedResidualUNet_EncENC2')
    parser.add_argument("--grp_regex", type=str, default='(\d+_\d+)_\d+')
    parser.add_argument("--n_class", type=int,  default=25)
    parser.add_argument("--metric_axis", type=int, nargs='+', help="Classes to display metrics", default=range(1,25))
    ...
    parser.add_argument("--losses", type=str, 
                        help="List of (loss_name, loss_params, bounds_name, bounds_params, fn, weight)", 
                        default="[('CrossEntropy', {'idc': range(0,25)}, None, None, None, 1)]")
