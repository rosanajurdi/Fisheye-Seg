...
# Job name
#SBATCH -J "ResidualUNet.run"

# Batch output file
#SBATCH --output logs/ResidualUNet.o%J

# Batch error file
#SBATCH --error errors/ResidualUNet.e%J
...
python3 /home/2017011/reljur01/WoodScape_Segmentation_Project/main_Dec_2.py
