...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataset', type=str, default='/media/eljurros/1 TB/Real_Data/FOLD_1')
    parser.add_argument("--csv", type=str, default= 'metrics.csv')
    parser.add_argument("--workdir", type=str, default = '/media/eljurros/1 TB/Real_Data/results/trial')
    ...
    parser.add_argument("--losses", type=str, 
                        ...
                        default="[('GeneralizedDice', {'idc': [0,1,2,3,4,5,6,7]}, None, None, None, 1)]")
