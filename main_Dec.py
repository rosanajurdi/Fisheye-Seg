...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataset', type=str, default='/home/2017011/reljur01/Synthetic_data/FOLD_M2')
    parser.add_argument("--csv", type=str, default= 'metrics.csv')
    parser.add_argument("--workdir", type=str, default = '/home/2017011/reljur01/Synthetic_data/FOLD_M2/results/DRU_DEC3')
    parser.add_argument('--batch_size', type=int, default=2)
    parser.add_argument("--cpu", action='store_true', default = False)
    parser.add_argument("--debug", action="store_true", default = False)
    parser.add_argument("--modalities", type=int, default=3)
    parser.add_argument("--weights", type=str, default='/home/2017011/reljur01/Synthetic_data/FOLD_M2/results/DRU_DEC2/best.pkl', help="Stored weights to restore")
    ...
    parser.add_argument("--network", type=str,  help="The network to use", default='DeformedResidualUNet_Decoder')
