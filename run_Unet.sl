...
# Job name
#SBATCH -J "bORRirr.run"

# Batch output file
#SBATCH --output logs/bORRirr.o%J

# Batch error file
#SBATCH --error errors/bORRirr.e%J
...
python3 /home/2017011/reljur01/WoodScape_Segmentation_Project/main_Unet.py
