...
import metrics
root = '/home/2017011/reljur01/Synthetic_data/FOLD_M2/val'

net_path = '/home/2017011/reljur01/Synthetic_data/FOLD_M2/results/ResidualUNet_FINAL/best.pkl'
print(net_path)
    ...
    for file in tqdm(files):
        ...
        if 'ff' in str(file):
            ...
            if len(np.unique(gt)) >0:      
                ...
                #    break
class_iou, mean_iou = metric.value()
with open(Path(exp_path, "{}_FV_MiOu.txt".format(os.path.basename(exp_path))), 'w') as f:
                f.write('class iou: {}\n'.format(class_iou))
