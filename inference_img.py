...
import metrics
root = '/home/2017011/reljur01/OMNIDATA/FOLD_3/val'
net_path = 'sftp://reljur01@myria.criann.fr/gpfs1/home/2017011/reljur01/Synthetic_data/FOLD_M3/results/DRU_Enc1_2/best.pkl'
fold = 'FOLD_3'
print(net_path)
...
metric = metrics.IoU(10, 'woodscape_syn', ignore_index=0)
...
class_iou, mean_iou = metric.value()
with open(Path('/home/2017011/reljur01/OMNIDATA/TXT_files',fold, "{}_FV_MiOu.txt".format(os.path.basename(exp_path))), 'w') as f:
                f.write('class iou: {}\n'.format(class_iou))
